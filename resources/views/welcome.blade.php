...
<body>
                    ...
                    <div class="rounded border jobs-wrap">
                        ...
                        <a href="job-single.html"
                            ...
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="eternal/images/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center freelance">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="eternal/images/logo_1.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center partime">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="eternal/images/logo_2.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
    ...
    <div class="site-blocks-cover overlay inner-page" style="background-image: url('eternal/images/hero_1.jpg');"
